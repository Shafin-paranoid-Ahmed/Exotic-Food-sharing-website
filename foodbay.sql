...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 18, 2024 at 09:58 PM
...
INSERT INTO `bid_board` (`bid_id`, `upload_time`, `discounted_price`, `bid_price`, `item_id`, `user_id`, `supplier_id`, `customer_id`) VALUES
(1, '2024-09-19 01:00:00.000000', 4420, 15520, 1, 1, 10001, 1);
...
INSERT INTO `item` (`item_id`, `item_name`, `item_rating`, `quantity`, `price`, `supplier_id`, `item_image_place`, `Sold_flag`) VALUES
(1, 'MOBY DICK', 5.00, 10, 150, 10001, 'NULL', 0);
