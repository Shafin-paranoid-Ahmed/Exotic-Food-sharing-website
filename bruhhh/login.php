...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $flag = $flagrow["flag"];
    if ($flag == 1){
        $sql = "SELECT u.user_id as user_id, u.email, u.password, c.customer_id, u.name as username FROM user u, customer c WHERE email = '$email' AND password = '$password' and c.user_id = u.user_id";
